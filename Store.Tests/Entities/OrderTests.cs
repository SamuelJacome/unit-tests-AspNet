...
namespace Store.Tests.Entities
{
   ...
   {
      private readonly Customer _customer = new Customer("Samuel Victor", "samuel.victorengenharia@gmail.com");
      private readonly Product _product = new Product("Produto 1", 10, true);
      private readonly Discount _discount = new Discount(10, DateTime.Now.AddDays(5));

      [TestMethod]
      [TestCategory("Domains")]
      ...
      [TestMethod]
      [TestCategory("Domains")]
      public void Dado_um_novo_pedido_valido_o_valor_do_pedido_deve_ser_50()
      {
         var order = new Order(_customer, 0, null);
